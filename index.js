             ...
             post += `   
                <section>
                    <div class="flex-au margin0">
                        <img class="post-avatar margin0" src="${posts[i].avatar}">
                        <div class="flex-ul">
                            <h1 class="margin0">${posts[i].name}</h1>
                            <h2 class="margin0">${posts[i].location}</h2>
                        </div>
                    </div>
                    <img class="img-post margin0" src="${posts[i].post}">
                    ...
                    <h3 class="likes margin0">${posts[i].likes} likes</h3>
                 ...
                 post += `   
                    <section>
                        ...
                        <div class="user-captionborder"></div>
                    </section> `
            }
